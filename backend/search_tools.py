...
class CourseOutlineTool(Tool):
    """Tool for retrieving a course outline from the catalog"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Retrieve a course outline — returns the course title, course link, and a numbered list of all lessons with their titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
